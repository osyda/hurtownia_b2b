  ...
  return (
    <div className="p-8">
      <PageHeader
        ...
        action={
          <Link href={`/${tenantSlug}/customers/new`} className="inline-flex items-center gap-2 bg-[#1D2125] text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-[#16191C] transition-colors">
              ...
              {customers.map(c => {
                ...
                return (
                  <tr key={c.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-4 py-3">
                      <Link href={`/${tenantSlug}/customers/${c.id}`} className="text-sm text-[#1D2125] hover:underline">Edytuj</Link>
                    </td>
                  </tr>
                )
              })}
