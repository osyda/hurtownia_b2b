  ...
  return (
    <div className="p-8">
      <PageHeader
        ...
        action={
          <Link href={`/${tenantSlug}/products/new`} className="inline-flex items-center gap-2 bg-blue-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-blue-700 transition-colors">
              ...
              {products.map(product => {
                ...
                return (
                  <tr key={product.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-4 py-3">
                      <Link href={`/${tenantSlug}/products/${product.id}`} className="text-sm text-blue-600 hover:underline">
                        Edytuj
                      </Link>
                    </td>
                  </tr>
