  ...
  return (
    <div className="p-4 md:p-8">
      <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <Link
          href="/tenants/new"
          className="inline-flex items-center justify-center gap-2 rounded-lg bg-[#1D2125] px-4 py-2.5 text-sm font-bold text-white shadow-sm transition hover:bg-[#16191C]"
        >
            ...
            return (
              ...
              >
                <div
                  ...
                  style={{ backgroundColor: tenant.brand_color || '#1D2125' }}
                >
                ...
                <div className="min-w-0">
                  ...
                  <div className="mt-1 flex min-w-0 items-center gap-2 text-xs text-slate-500">
                    ...
                    <span className="truncate font-mono font-semibold text-[#1D2125]">{shopUrl}</span>
                  </div>
                ...
                <div className="rounded-lg border border-slate-200 bg-slate-50 p-3">
                  ...
                  <div className="h-1.5 overflow-hidden rounded-full bg-slate-200">
                    <div className="h-full rounded-full bg-[#1D2125]" style={{ width: `${onboarding.score}%` }} />
                  </div>
                </div>
