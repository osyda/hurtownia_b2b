    ...
    <div>
      ...
      {orders?.length ? (
          ...
          {orders.map(order => {
            ...
            return (
              <Link
                ...
                className="flex items-center justify-between premium-card p-4 hover:border-[#27C7C3] hover:shadow-sm transition-all"
              >
        ...
        <div className="premium-card p-16 text-center">
          ...
          <Link href={`${shopBasePath}/katalog`} className="inline-block mt-4 text-sm text-[#0F4D38] hover:underline">
            Przejdź do katalogu →
          </Link>
        </div>
      )}
