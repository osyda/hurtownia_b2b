    ...
    <div className="p-8 max-w-4xl">
        ...
        {(['products', 'stock'] as ImportMode[]).map(m => (
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-colors ${
              mode === m ? 'bg-[#1D2125] text-white' : 'bg-white border text-gray-600 hover:bg-gray-50'
            }`}
          >
      ...
      <div className="premium-card mb-6">
        ...
        <div className="p-5 space-y-4">
          ...
          <label className="flex flex-col items-center justify-center border-2 border-dashed border-gray-300 rounded-xl p-8 cursor-pointer hover:border-[#E08A2B] hover:bg-[#FFF7ED] transition-colors">
