      ...
      <div className="premium-card p-6 space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="space-y-1">
            ...
            <input name="min_order_qty" type="number" step="0.001" min="0" defaultValue={product?.min_order_qty ?? '1'} className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-slate-900/15" />
          </div>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="space-y-1">
            <label className="block text-sm font-medium text-gray-700">Wielokrotność zamówienia</label>
            <input name="order_multiple" type="number" step="0.001" min="0" defaultValue={product?.order_multiple ?? '1'} className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-slate-900/15" />
          </div>
        </div>
      </div>
