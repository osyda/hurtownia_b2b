      ...
      <div className="flex gap-2 mb-6">
        <button
          ...
          className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-colors ${
            tab === 'groups' ? 'bg-[#1D2125] text-white' : 'bg-white border text-gray-600 hover:bg-gray-50'
          }`}
        >
        ...
        <button
          ...
          className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-colors ${
            tab === 'customers' ? 'bg-[#1D2125] text-white' : 'bg-white border text-gray-600 hover:bg-gray-50'
          }`}
        >
              ...
              <div key={group.id}>
                {editingGroup === group.id ? (
                  <form
                    ...
                    className="p-4 grid grid-cols-2 gap-3 bg-[#FFF7ED]"
                  >
                  ...
                  <div className="p-4 flex items-center justify-between">
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className="p-1.5 text-gray-400 hover:text-[#1D2125] transition-colors"
                      >
              ...
              {customers.map(c => (
                <button
                  ...
                  className={`w-full text-left p-3 hover:bg-gray-50 transition-colors ${
                    selectedCustomer === c.id ? 'bg-[#FFF7ED]' : ''
                  }`}
                >
